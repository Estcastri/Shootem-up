...
private:
    ...
    Color color0, color1, color2;  // <- Agregado
...
public:
    Triangle(
        ...
        Color color0Argument = Color(1.0f, 0.0f, 0.0f, 1.0f),
        Color color1Argument = Color(0.0f, 1.0f, 0.0f, 1.0f),
        Color color2Argument = Color(0.0f, 0.0f, 1.0f, 1.0f)
    )
